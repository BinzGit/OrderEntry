System.register(['@angular/http'], function(exports_1, context_1) {
    ...
    return {
        ...
        execute: function() {
            ...
            TOKEN_URL = '/api/token';
            COMPAY_SEARCH_URL = '/api/Company/KeywordSearch/{0}?page=1&pageSize=1000&sort=companyName';
            ORDER_SEARCH_URL = '/api/OrderSummary/KeywordSearch/{0}?page=1&pageSize=1000';
            COMPAY_GET_URL = '/api/Company/';
            COMPAY_POST_URL = '/api/Company/';
