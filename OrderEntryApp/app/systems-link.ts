 ...
 const TOKEN_URL: string =  '/api/token';
 const COMPAY_SEARCH_URL: string =  '/api/Company/KeywordSearch/{0}?page=1&pageSize=1000&sort=companyName';
 const ORDER_SEARCH_URL: string =  '/api/OrderSummary/KeywordSearch/{0}?page=1&pageSize=1000';
 const COMPAY_GET_URL: string =  '/api/Company/';
 const COMPAY_POST_URL: string =  '/api/Company/';
